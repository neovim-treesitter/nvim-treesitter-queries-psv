# nvim-treesitter-queries-psv

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-psv/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-psv/actions/workflows/validate.yml)

Neovim tree-sitter queries for **psv**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-psv",
...
- [ ] Changes are scoped to `psv` — do not include files for other languages
